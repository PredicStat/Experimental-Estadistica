...
<figure style="text-align: center;">
  ...
  <div style="display: flex; justify-content: center; gap: 20px;">
    <img src="Graficos/3.jpg" style="width: 50%;">
    <img src="Graficos/4.jpg" style="width: 50%;">
  </div>

  <figcaption style="margin-top: 10px;">
    Figura 1. Elaboración de los Aviones de Papel.
  </figcaption>
...
library(knitr)
knitr::include_graphics("Graficos/Normalidad.jpg")
```
...
<div style="display: flex; justify-content: center;">
  <img src="Graficos/Efectos.jpg" style="width: 50%; margin-right: 10px;">
  <img src="Graficos/Interacciones.jpg" style="width: 50%;">
</div>
